...
- Links to test files
- Basic ChemFig options (3 controls)
...
- `http://localhost:5001` - Mol2ChemFig (optional)
...
Fixed by replacing basic unified interface with full `test_m2cf_full.html` interface

### ✅ OPSIN 3D SMILES Generation
**Fixed:** `mol2chemfig_server.py` line 575
