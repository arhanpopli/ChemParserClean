...
**Technology:** Flask (Python) with NATIVE mol2chemfig library
**Purpose:** ChemFig LaTeX conversion, OPSIN 3D SMILES
**Docker is now OPTIONAL** ✅ (Native Python implementation - November 2025)

**Key Files:**
- `mol2chemfig_server.py` - Flask server with native mol2chemfig integration
