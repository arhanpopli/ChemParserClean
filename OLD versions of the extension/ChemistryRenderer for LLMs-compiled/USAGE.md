...
*ChemistryRenderer Extension Guide*
...
**Examples:**
chem:<name>smiles=CCO: (Direct SMILES - always specify compound name under it)
...
chem:aspirin: (Auto-detect compound type)
...
4. Place chemistry renders in code blocks for reactions/conversions, place them side by side only
