        ...
        switch (viewerSource) {
          ...
          default:
            ...
            viewerUrl = chrome.runtime.getURL(
              `viewers/3dmol-viewer.html?name=${encodeURIComponent(compoundName)}&style=${style3D}&stickRadius=${stickRadius}&sphereRadius=${sphereRadius}&autoRotate=${autoRotate}&bgColor=${bgColor}`
            );
